...
plt.ylabel('CG y-height % shift')
plt.subplot(212)
plt.scatter(CGpctShift_array[:, 0], CGpctShift_array[:, 1], c = brakeTorque_Liftarray, marker = 's', s = 200, vmin = min(brakeTorque_Liftarray), vmax = max(brakeTorque_Liftarray))
plt.colorbar()
